        ...
        <div class="card-body">
          ...
          ${holidayDraft.is_closed ? "" : `
            ...
            <div class="inline-form" style="margin-bottom:10px;">
              ${timeSelect('id="holidayOpens"', holidayDraft.opens_at)}
              ${timeSelect('id="holidayCloses"', holidayDraft.closes_at)}
            </div>
          `}
      ...
      <div class="card-body">
        ${storeData.store_hours.map(row => `
          <div class="inline-form" style="margin-bottom:8px;">
            ...
            ${timeSelect(`data-opens="${row.weekday}" ${row.is_closed ? "disabled" : ""}`, row.opens_at)}
            ${timeSelect(`data-closes="${row.weekday}" ${row.is_closed ? "disabled" : ""}`, row.closes_at)}
