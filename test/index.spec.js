...
describe("shelf layout and guides", () => {
  const unit = (over = {}) => ({ tier_count: 4, usable_height_in: 72, ...over });
  const family = (over = {}) => ({
    id: 1, name: "MG", guide_pieces: 12, sku_count: 123, placement: "tier", ...over
  });
